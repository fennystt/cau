...
if ($register == false)
    ...
    if ($verif == false)
        ...
        if ($claim == false)
            ...
            echo "\e[92m[!]".$voucher."\n";
            sleep(3);
            echo "\e[93m[!] Trying to redeem Voucher : GPCIMLEK20 !\n";
            sleep(3);
            goto next;
            }
            else{
                echo "\e[92m[+] ".$claim."\n";
                sleep(3);
                echo "\e[93m[!] Trying to redeem Voucher : GOPAYFATCHAIXXI !\n";
                sleep(3);
                goto ride;
            }
            next:
            ...
            if ($claim == false) {
                ...
                sleep(3);
                echo "\e[93m[!] Trying to redeem Voucher : GOPAYKIRIMPAKET !\n";
                sleep(3);
                goto next1;
            }
            else{
                echo "\e[92m[+] ".$claim."\n";
                sleep(3);
                echo "\e[93m[!] Trying to redeem Voucher : PARKIRPAKEGOPAY !\n";
                sleep(3);
                goto ride;
            }
            next1:
