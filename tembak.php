...
echo color("red","| github: CAU |\n");
echo color("red","| fanspage :4CAU|\n");
echo color("red","| Creator : CAU.com          |\n");
...
// function change(){
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOPAYKIRIMPAKET"}');
